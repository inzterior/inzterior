export const meta = {
  ...
  description:
    "A practitioner's guide to renovation warranty and defect liability periods in Malaysia — what should be covered, response-time expectations, and the red flags to watch for.",
  keywords: [
