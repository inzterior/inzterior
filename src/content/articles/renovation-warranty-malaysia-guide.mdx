export const meta = {
  ...
  description:
    "A practitioner's guide to renovation warranty and defect liability periods in Malaysia — what should be covered, how long is reasonable, and the red flags to watch for.",
  keywords: [
...
This is the question I get asked most directly, and it's the one I want to answer carefully rather than give you a number that sounds authoritative but isn't grounded in anything.

What actually matters isn't chasing some universal industry figure — because in Malaysia's renovation trade, there isn't a single standardised one that applies across the board the way, say, a statutory warranty period might for certain regulated products. What matters is that your contract states a specific, defined period in writing, with a clear start date (usually the handover date) and a clear end date. "We'll take care of you" is not a defect liability period. A number of months, written into the document you both sign, is.

{/* VERIFY: state Inzterior's actual defined warranty period here once confirmed by Billy/Jackie */}

When you're comparing quotes, ask each contractor to state their period plainly and put it in the contract, not just say it out loud during the sales conversation. If someone is cagey about writing a number down, that hesitation tells you something worth paying attention to.
